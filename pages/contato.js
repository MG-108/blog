...
const Contact = () => {
  return (
    <div className="md:my-16 pt-12   ">
      <div className="my-20 py-10 bg-white dark:bg-secondary-dark-bg shadow-xl rounded-lg mx-10 md:mx-16  p-3 md:p-6 lg:p-10  dark:text-white mb-80">
        <Head>
        ...
        <p className="mb-2">
          Obrigado por visitar o nosso site. Se você tiver alguma dúvida ou precisar de mais
          informações, entre em contato conosco pelo e-mail abaixo.
        </p>
